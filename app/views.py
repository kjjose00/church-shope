...
def address(request):
    ...
    return render(request, 'app/address.html',{'ads':ads,'active':'btn-primary'})
@login_required
def orders(request):
    op=OrderPlaced.objects.filter(user=request.user)
    for o in op:
        total=o.product.discounted_price*o.quantity
    
    return render(request, 'app/orders.html',{'order_placed':op,'total':total})
...
def mobile(request,data=None):
    if data==None:
        mobiles=Product.objects.filter(category='M')
    elif data=='samsung' or data=='apple' or data=='Redmi' or data=='tcl' or data=='poco':
...
def topwear(request,data=None):
    if data==None:
        topwears=Product.objects.filter(category='TW')
    elif data=='steele' or data=='stelee' or data=='avenue' or data=="church" or data=='priestly':
...
def bottomwear(request,data=None):
    if data==None:
        bottomwears=Product.objects.filter(category='BW')
    elif data=='park' or data=='juke' or data=='church' or data=="standard" or data=='good' or data=='Elegant' or data=='new':
